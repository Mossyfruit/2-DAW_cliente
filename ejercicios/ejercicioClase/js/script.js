...
import {  mostrarResPila } from './mostrarResPila.js';
import { generaN } from './aleatorio.js';
import {  mostrarResCola } from './mostrarResCola.js';
import {  mostrarResLista, mostrarResListaPrior } from './mostrarResLista.js';
import {  ListaTarea } from './ListaTarea.js';
import {  parahacer } from './parahacer.js';
import {  cumplido, cumplidoPrioridad } from './cumplido.js';
...
eliminar.addEventListener("click", function () {
    console.log(`He hecho: ${cumplido(listaTarea)}`);
    mostrarResLista(listaTarea);
});
